<div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/public/img/carousel1.jpg" class="d-block w-100" alt="Carousel 1">
        ...
        <div class="carousel-item">
            <img src="/public/img/carousel2.jpg" class="d-block w-100" alt="Carousel 2">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="/public/img/carousel3.webp" class="d-block w-100" alt="Carousel 3">
            <div class="carousel-caption d-none d-md-block">
